...
class Structure extends User_Controller {
	const IMAGE_TYPE = 3;

	private $services = null;
    private $name = null;
    private $parent_page = '4dmin';
	private $current_page = '4dmin/structure/';
	...
	public function index()
	{
		...
		$table[ "rows" ] = $this->gallery_model->galleries( Structure::IMAGE_TYPE, $pagination['start_record'], $pagination['limit_per_page'] )->result();

		$table = $this->load->view('templates/tables/plain_table_image', $table, true);
		$this->data[ "contents" ] = $table;
		$add_menu = array(
			"name" => "Tambah Gambar Struktur",
		...
		$this->data["block_header"] = "Struktur Organisasi";
		$this->data["header"] = "Struktur Organisasi";
	...
	public function add(  )
	{
        ...
        if ($this->form_validation->run() === TRUE )
        {
			...
			$filename = "Structure_".$data['name']."_".time();
			$upload_path = 'uploads/structures/';
